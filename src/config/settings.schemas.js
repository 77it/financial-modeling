...
const SettingsSchemas = {
  ...
  [Simulation.$$DEFAULT_SPLIT]: schema.ARRAY_OF_NUMBERS_TYPE,
  [Simulation.$$DRIVER_PREFIXES__ZERO_IF_NOT_SET]: schema.ARRAY_OF_STRINGS_TYPE,
  [Simulation.$$INVENTORY_VALUATION_METHOD]: schema.STRING_TYPE,
  ...
  // test setting
  [Simulation._TEST_ONLY__YAML_PARSE_AND_VALIDATION_TEST]: { mamma: schema.STRING_TYPE, babbo: schema.NUMBER_TYPE },
};
