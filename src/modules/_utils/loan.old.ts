...
class Loan {
    ...
    constructor(settings: LoanSettings) {
        ...
        this.#periodicPaymentAmount = this.toBD(calculatePeriodicPaymentAmountOfAConstantPaymentLoan(this.#settings.initialRateForConstantPaymentCalculation, this.#settings.numberOfAnnualPayments, this.#numberOfRemainingPayments, this.#settings.initialPrincipal));
...
interface LoanSuspendedPayments {
    [startDate: string]: {
        end: Date;
...
enum LoanSettingsSuspendedPaymentsType {
