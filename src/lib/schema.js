...
export const NUMBER_TO_DATE_OPTS = {
  NUMBER_TO_DATE__EXCEL_1900_SERIAL_DATE: 'NUMBER_TO_DATE__EXCEL_1900_SERIAL_DATE',
  NUMBER_TO_DATE__JS_SERIAL_DATE: 'NUMBER_TO_DATE__JS_SERIAL_DATE',
  NUMBER_TO_DATE__NO_CONVERSION: 'NUMBER_TO_DATE__NO_CONVERSION'
};
Object.freeze(NUMBER_TO_DATE_OPTS);
//#endregion types
