export { convertExcelToJsonlFile };
...
/**
 * Convert Excel file to a JSONL file.
 * @param {Object} p
 * @param {string} p.excelInput - Excel file with user input
 * @param {string} p.jsonlOutput - Excel file with user input
 * @return {Promise<void>} - Create a JSONL and return nothing
 * @throws {Error} - If the platform is not Windows or if there are errors during conversion
 */
async function convertExcelToJsonlFile ({ excelInput, jsonlOutput }) {
