...
import { DSB, _TEST_ONLY__set } from '../../src/lib/decimal_scaled_bigint__dsb.arithmetic_x.js';
...
t('calculatePeriodicPaymentAmountOfAConstantPaymentLoan #1', async () => {
  _TEST_ONLY__set(
    ...
    { decimalScale: 11, accountingDecimalPlaces: 4, roundingMode: ROUNDING_MODES.HALF_EVEN });
});
