//@ts-nocheck
//<file bigint_decimal_scaled.arithmetic_1.test.js>
...
//#endregion ========= Deterministic vectors @ HALF_UP =========

//#region ========= Mode flip: HALF_EVEN quick sanity (keeps scale 20) =========
...
t('HALF_EVEN – sanity vs HALF_UP tie behavior (constructed ties)', () => {
  _TEST_ONLY__set(
    ...
    { decimalScale: SCALE, accountingDecimalPlaces: 4, roundingMode: ROUNDING_MODES.HALF_EVEN });
});
...
//#endregion ========= Mode flip: HALF_EVEN quick sanity (keeps scale 20) =========
...
t('Massive vector sweep (hand-picked pairs) – all ops', () => {
  _TEST_ONLY__set(
    ...
    { decimalScale: SCALE, accountingDecimalPlaces: 4, roundingMode: ROUNDING_MODES.HALF_UP }); // back to HALF_UP
});
