...
t('Agenda test', async () => {
  ...
  assert.deepStrictEqual(agenda.get({ date: new Date('2020-01-01') }), []);
  ...
  assert.deepStrictEqual(agenda.get({ date: new Date('2020-01-02') }), [{ isSimulation: true, data: { value: 3 } }]);
  assert.deepStrictEqual(agenda.get({ date: new Date('2020-01-03') }), []);
  assert.deepStrictEqual(agenda.get({ date: new Date('2020-01-04') }), [{ isSimulation: true, data: { value: 4 } }]);
});
