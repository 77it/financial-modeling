export const SimObjectTypes_All:any = {
...
BS_CREDIT__TAXCREDITS__PREPAIDTAX : "BS_CREDIT__TAXCREDITS__PREPAIDTAX",  // (ITA) Crediti_tributari__Vari
...
BS_GOOD__NONCURRENT_INTANGIBLE_ASSETS : "BS_GOOD__NONCURRENT_INTANGIBLE_ASSETS",  // (ITA) Immobilizzazioni_immateriali
BS_GOOD__NONCURRENT_TANGIBLE_ASSETS : "BS_GOOD__NONCURRENT_TANGIBLE_ASSETS",  // (ITA) Immobilizzazioni__materiali
...
BS_LIABILITY__GENERICPROVISIONS : "BS_LIABILITY__GENERICPROVISIONS",  // (ITA) Fondi_rischi_e_oneri
...
IS_INCOME__OTHERINCOME : "IS_INCOME__OTHERINCOME",  // (ITA) Altri_ricavi_e_proventi
IS_INCOME__OTHERINCOME__OPERATINGGRANTS : "IS_INCOME__OTHERINCOME__OPERATINGGRANTS",  // (ITA) Altri_ricavi_e_proventi
...
IS_EXPENSE__EMPLOYEEEXPENSE : "IS_EXPENSE__EMPLOYEEEXPENSE",  // (ITA) Costi_del_personale
...
IS_EXPENSE__OTHEREXPENSE : "IS_EXPENSE__OTHEREXPENSE",  // (ITA) Oneri_diversi
...
IS_EXPENSE__TAXEXPENSE__DEFERREDANDPREPAIDTAX : "IS_EXPENSE__TAXEXPENSE__DEFERREDANDPREPAIDTAX",  // (ITA) Imposte
