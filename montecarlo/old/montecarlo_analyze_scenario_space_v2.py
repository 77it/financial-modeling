...
def print_scenario_analysis(info: Dict, runs: int, time_per_run: Optional[int] = None):
    ...
    # Recommendations based on regime - using powers of 2 from RECOMMENDED_RUNS
    if regime == "tiny":
        quick = (64, 128)       # RECOMMENDED_RUNS[0:2]
        standard = (128, 256)   # RECOMMENDED_RUNS[1:3]
        rigorous = (256, 512)   # RECOMMENDED_RUNS[2:4]
    elif regime == "small":
        quick = (128, 256)      # RECOMMENDED_RUNS[1:3]
        standard = (256, 512)   # RECOMMENDED_RUNS[2:4]
        rigorous = (512, 1024)  # RECOMMENDED_RUNS[3:5]
    elif regime == "medium":
        quick = (256, 512)      # RECOMMENDED_RUNS[2:4]
        standard = (512, 1024)  # RECOMMENDED_RUNS[3:5]
        rigorous = (1024, 2048) # RECOMMENDED_RUNS[4:6]
    else:  # astronomical
        quick = (128, 256)      # RECOMMENDED_RUNS[1:3]
        standard = (256, 512)   # RECOMMENDED_RUNS[2:4]
        rigorous = (512, 1024)  # RECOMMENDED_RUNS[3:5]
