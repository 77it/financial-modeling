...
Deno.test('Agenda test', async () => {
  ...
  agenda.set({ date: new Date('2020-01-01'), value: 999, isSimulation: true, info: {} });
  agenda.set({ date: new Date('2020-01-01 10:18:25'), value: 1, isSimulation: true, info: { aaa: 999 } });  // the time part is ignored
  ...
  agenda.set({ date: new Date('2020-01-02'), value: 3, isSimulation: true, info: {} });
  agenda.set({ date: new Date('2020-01-04'), value: 4, isSimulation: true, info: {} });
  // add some historical items
  agenda.set({ date: new Date('2019-12-31'), value: 777, isSimulation: false, info: {} });
  ...
  assertEquals(
    ...
    [
      { value: 777, isSimulation: false, info: {} },
